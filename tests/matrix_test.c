...
static void test_double_transpose(void)
{
    ...
    Matrixf  t1, t2;
    matrix_create_stk(3, 2, t1d, &t1);
    matrix_create_stk(2, 3, t2d, &t2);
    matrix_T(&t1, a);
    matrix_T(&t2, &t1);
...
static void test_lu_reconstruct(void)
{
    ...
    Matrixf L, U, prod;
    matrix_create_stk(   3, 3, Ld, &L);
    matrix_create_stk(   3, 3, Ud, &U);
    matrix_create_stk(3, 3, prod_d, &prod);
